...
const checkWin = () => {
const flippedCards = document.querySelectorAll('.open')
if (flippedCards.length === 16){
  setTimeout(() => {
    alert('Game won! $1 will be donated to The Ocean Cleanup. Thank you for playing and preserving our oceans!');
